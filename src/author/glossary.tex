...
\runinhead{Broadcast} Broadcasting a vector involves duplicating it along a specified dimension. This is a common operation in neural networks, where a vector is broadcast to match the dimensions of a matrix.
